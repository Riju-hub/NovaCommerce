...
//           <h3 className="text-xl font-extrabold text-slate-900 tracking-tight">Check Your Inbox</h3>
//           <p className="text-xs text-slate-500 max-w-xs mx-auto leading-relaxed">
//             We sent password recovery instructions to{' '}
//             <span className="font-bold text-slate-800 bg-slate-100 px-2 py-0.5 rounded-md">{email}</span>
//           </p>
//         </div>
//         <div className="pt-2">
//           <Link
//             to="/login"
//             className="inline-flex items-center text-xs font-bold text-indigo-600 hover:text-indigo-700 hover:underline gap-1 transition-all"
//           >
...
//         <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-xs">
//           <KeyRound className="w-6 h-6" />
//         </div>
//         <h2 className="text-xl font-bold text-slate-900">Reset Your Password</h2>
//         <p className="text-xs text-slate-500 mt-1 leading-relaxed">
//           Enter your registered email and we'll send you link instructions.
//         </p>
//       </div>
